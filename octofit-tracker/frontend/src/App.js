    ...
    <Router>
      ...
      <div className="container">
        <Routes>
          ...
          <Route path="/" element={<div className="text-center mt-5"><h2 className="display-4">Welcome to Octofit Tracker!</h2><p className="lead">Track your fitness, join teams, and climb the leaderboard!</p></div>} />
        </Routes>
      </div>
    </Router>
  );
